...
litigation_probability_assessor = Agent(
...
settlement_value_calculator = Agent(
...
case_evaluation_team = Team(
    name="Case Evaluation Team",
    mode="route",
    model=Gemini("gemini-2.0-flash"),
    members=[
        litigation_probability_assessor,
        settlement_value_calculator,
        case_strategy_advisor,
        expert_witness_finder,
        client_intake_analyzer,
    ],
